 ...
 * @author alberto
 */
public class AddPostre extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPostre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void comprueba() {
        if (!txtNombre.getText().isEmpty() && !txtPrecio.getText().isEmpty()) {
            ...
            if (!Controlador.comprobar(nombre,"postre")) {
                String resultado = Controlador.add(nombre,Double.parseDouble(precio),"postre");
                lblResultadoAdd.setText(resultado);
            }else{
                Controlador.borrar(nombre, "postre");
                String resultado = Controlador.add(nombre,Double.parseDouble(precio),"postre");
                lblResultadoAdd.setText(resultado);
            }
