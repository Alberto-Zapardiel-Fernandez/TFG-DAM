 ...
 * @author alberto
 */
public class BorrarPostre extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarPostre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrarPostre().setVisible(true);
            }
        });
    }
    ...
    private void comprueba() {
        if (!txtUsuario.getText().isEmpty()) {
            ...
            if (respuesta == JOptionPane.YES_OPTION) {
                resultado = Controlador.borrar(nombre, "postre");
