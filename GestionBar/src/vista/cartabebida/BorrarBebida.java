 ...
 * @author alberto
 */
public class BorrarBebida extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarBebida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrarBebida().setVisible(true);
            }
        });
    }
    ...
    private void comprueba() {
        if (!txtUsuario.getText().isEmpty()) {
            ...
            if (respuesta == JOptionPane.YES_OPTION) {
                resultado = Controlador.borrar(nombre, "bebida");
