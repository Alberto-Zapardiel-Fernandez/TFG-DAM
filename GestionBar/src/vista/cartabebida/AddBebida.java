...
public class AddBebida extends javax.swing.JFrame {
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        GestionaBebida gestionaComida = new GestionaBebida();
    ...
    private void comprueba() {
        if (!txtNombre.getText().isEmpty() && !txtPrecio.getText().isEmpty()) {
            String bebida = txtNombre.getText().trim();
            String precio = txtPrecio.getText().trim();
            
            if (!Controlador.comprobar(bebida,"bebida")) {
                String resultado = Controlador.add(bebida,Double.parseDouble(precio),"bebida");
                lblResultadoAdd.setText(resultado);
            }else{
                Controlador.borrar(bebida, "bebida");
                String resultado = Controlador.add(bebida,Double.parseDouble(precio),"bebida");
                lblResultadoAdd.setText(resultado);
            }
