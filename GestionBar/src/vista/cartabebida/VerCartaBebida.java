 ...
 * @author alberto
 */
public class VerCartaBebida extends javax.swing.JFrame {
    ...
    public void cargaTabla() {
        ...
        ArrayList<Object[]>datos = Controlador.obtenerLista("bebida");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerCartaBebida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerCartaBebida().setVisible(true);
            }
        });
    }
