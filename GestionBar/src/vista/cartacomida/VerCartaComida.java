 ...
 * @author alberto
 */
public class VerCartaComida extends javax.swing.JFrame {
    ...
    public void cargaTabla() {
        ...
        ArrayList<Object[]>datos = Controlador.obtenerLista("comida");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerCartaComida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerCartaComida().setVisible(true);
            }
        });
    }
